...
diretorio = r'c:\\_diogenes_\\LEXi\AtasRead_legado\\melhoria_textos\\temp\\'
...
if conn.is_connected():        
        ...
        query = "SELECT iddocumento, idLegado FROM classificador.legado Where iddocumento='8567922' "
